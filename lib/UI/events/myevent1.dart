...
class MyEvents1 extends StatefulWidget {
  const MyEvents1({super.key});

  @override
  State<MyEvents1> createState() => _MyEventsState1();
}

class _MyEventsState1 extends State<MyEvents1> {
        ...
        body: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context,  snapshot) {
            return ListView.builder(
              itemCount: snapshot.data?['event_participated'].length,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    InkWell(
                        ...
                        Text("Event name: ${snapshot.data?['event_participated'][index]['event_name']}",style: TextStyle(
                            fontSize: 20,
                              color: Colors.black,
                        ...
                        Text("Event date: ${DateFormat('dd-MM-yyyy').format(snapshot.data?['event_participated'][index]['event_date'].toDate())}",style: TextStyle(
                            fontSize: 20,
                              color: Colors.black,
                              fontWeight: FontWeight.w600),),
                      ]
